...
import cv2
import copy
cap = cv2.VideoCapture('/Users/hykuan/Documents/GSLab/hand/hand1.mp4') 
...
while(cap.isOpened()):
    ...
    if ret == True:
        ...
        result=cv2.absdiff( gray,int_32_gray)
        #cv2.subtract(int_32_gray,gray)
        ret, img2 = cv2.threshold(result, 10, 255, cv2.THRESH_BINARY)
